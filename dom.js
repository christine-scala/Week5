//use JS to change the styles of each of the elements in your list can be as basic as .color
...
document.getElementById("two").childNodes[1].className="ahahah";

//Change the text value of your last item in your list using sibling - in js
document.getElementById("last").nextSibling.textContent="Final";